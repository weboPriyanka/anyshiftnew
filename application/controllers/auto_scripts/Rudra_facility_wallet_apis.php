...
class Rudra_facility_wallet_apis extends CI_Controller
{                   
	...
	public function __construct()
    {
        ...
        $this->table = 'rudra_facility_wallet';
    ...
    /***********************Page Route
     ...
     //rudra_facility_wallet API Routes
	$t_name = 'auto_scripts/Rudra_facility_wallet_apis/';    
	$route[$api_ver.'facility_wallet/(:any)'] = $t_name.'rudra_rudra_facility_wallet/$1';
    ...
    **********************************/
    ...
    public function rudra_rudra_facility_wallet($param1)
    {
        $call_type = $param1;
        $res = array();
        if($call_type == 'put')
    ...
    {     
        if(!empty($_POST))
        {
			...
			$this->form_validation->set_rules('fo_id', 'fo_id', 'required');
			$this->form_validation->set_rules('fw_total_credit', 'fw_total_credit', 'required');
			$this->form_validation->set_rules('fw_used', 'fw_used', 'required');
			$this->form_validation->set_rules('fw_balance', 'fw_balance', 'required');
