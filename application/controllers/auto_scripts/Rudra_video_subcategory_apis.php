...
class Rudra_video_subcategory_apis extends CI_Controller
{                   
	...
	public function __construct()
    {
        ...
        $this->table = 'rudra_video_subcategory';
    ...
    /***********************Page Route
     ...
     //rudra_video_subcategory API Routes
    ...
    **********************************/
    ...
    public function rudra_rudra_video_subcategory($param1)
    {
        $call_type = $param1;
        $res = array();
        if($call_type == 'put')
    ...
    {     
        if(!empty($_POST))
        {
            ...
            { 
                ...
                $query = "SELECT rudra_video_subcategory.id,rudra_video_category.cat_name,rudra_video_subcategory.subcat_name,rudra_video_subcategory.added_on,rudra_video_subcategory.updated_on FROM $this->table  LEFT JOIN rudra_video_category ON $this->table.cat_id = rudra_video_category.id ORDER BY id DESC LIMIT $start_index , $per_page";
