...
{                   
    ...
    public function post_actions($param1)
    {
        ...
        if($action == "get_data")
        {
            ...
            $html = $this->load->view("tv/forms/_ajax_rudra_video_category_form", $data, TRUE);
        ...
        {
			$validations = array(array('field' => 'cat_name', 'label' => 'Category Name', 'rules' => 'trim|required|min_length[3]'));
