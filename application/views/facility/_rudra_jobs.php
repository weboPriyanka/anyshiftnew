                        ...
                        <h5><?= $page_header ?></h5>
                            ...
                            <div class="col-sm-7 text-right">
                               <!-- <button onclick="static_form_modal('rudra_jobs/post_actions/get_data?id=0','rudra_jobs/post_actions/insert_data','md','Update Details')" type="button" class="btn btn-glow-success btn-info" title="" data-toggle="tooltip" data-original-title="Add New Item" aria-describedby="tooltip651610">New</button>-->&nbsp;
                                <a href="facility-jobs/post_actions/export_data" type="button" class="btn btn-glow-danger btn-warning" title="" data-toggle="tooltip" data-original-title="Export CSV" aria-describedby="tooltip651610">CSV</a>
...
$("#filter").submit(function(e) {
   ...
   var start_date = $('#start_date_stat').val();
    ...
    fill_server_data_table(search_json,job_id, searchBy,sm_id,searchBySM,start_date,end_date);
  });
 $.fn.dataTable.ext.errMode = 'throw';
var usrTable;
fill_server_data_table(search_json);
function fill_server_data_table(search_json,job_id = "", searchBy ="",sm_id ="",searchBySM ="",start_date = "",end_date=""){
...
responsive: true,
"ajax": {
	"url": "<?php echo base_url('facility-jobs/list') ?>",
	"dataType": "json",
	"type": "POST",
	"data": {
