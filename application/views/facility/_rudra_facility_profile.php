                    ...
                    <div class="card-block">
					  <div class="row">
					   <div class="col-lg-4">
							...
							<h6 class="mb-1"><?php echo $profileDetails['fo_fname'].'&nbsp;'.$profileDetails['fo_lname'];?></h6>
							<p class="mb-0 text-muted">Facility Owner</p>
							</div>
							</div>
							</div>
							...
							<a href="mailto:<?php echo $profileDetails['fo_email'];?>" class="float-end text-body"><?php echo $profileDetails['fo_email'];?></a>
							</li>
							<li class="list-group-item">
							<span class="f-w-500"><i class="feather icon-phone-call m-r-10"></i>Phone : </span>
							<a href="#" class="float-end text-body"><?php echo $profileDetails['fo_mobile'];?></a>
							</li>
							<li class="list-group-item">
							<span class="f-w-500"><i class="fas fa-hand-holding-usd m-r-10"></i>Balance Left : </span>
							<a href="#" class="float-end text-body"><?php echo $walletDetails['fw_balance'];?></a>
							</li>
							<li class="list-group-item">
							<span class="f-w-500"><i class="fas fa-hand-holding-usd m-r-10"></i>Total Credit : </span>
							<a href="#" class="float-end text-body"><?php echo $walletDetails['fw_total_credit'];?></a>
							</li>
...
<span class="float-end"><i class="feather icon-chevron-right"></i></span>
					 ...
					 <div class="col-lg-8">
							...
							<div class="card-body">
							<div class="row">
							<input type="hidden" class="form-control" name="fo_original" value="<?php echo $profileDetails['fo_email'];?>" required />
							<div class="col-sm-6">
							<div class="form-group">
							<label class="form-label">First Name <span class="text-danger">*</span></label>
							<input type="text" class="form-control" name="fo_fname" value="<?php echo $profileDetails['fo_fname'];?>" required />
							</div>
							</div>
							<div class="col-sm-6">
							<div class="form-group">
							<label class="form-label">Last Name <span class="text-danger">*</span></label>
							<input type="text" class="form-control" name="fo_lname" value="<?php echo $profileDetails['fo_lname'];?>" required />
							</div>
							</div>
							<div class="col-sm-6">
							<div class="form-group">
							<label class="form-label">Contact Phone</label>
							<input type="text" class="form-control" name="fo_mobile" value="<?php echo $profileDetails['fo_mobile'];?>" required />
							</div>
							</div>
							<div class="col-sm-6">
							<div class="form-group">
							<label class="form-label">Email <span class="text-danger">*</span></label>
							 <input type="email" class="form-control" name="fo_email" value="<?php echo $profileDetails['fo_email'];?>" required />
							</div>
							</div>
							</div>
...
$("#changePassword").submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('facility-edit-password');?>',
                data: formData,
                cache: false,
                processData: false,
                contentType: false,
		...
		$("#updateProfile").submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('facility-update-profile');?>',
                data: formData,
                cache: false,
                processData: false,
                contentType: false,
