    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light header-purple" style="background:#33277F;">
        <div class="m-header">
            ...
            <a href="<?= base_url() ?>" class="b-brand">
               ...
               <span class="b-title">WebFxm</span>
           </a>
        </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                           ...
                           <ul class="noti-body">
								...
								<?php if(!empty($this->default_data['data']['FoJobNotifications'])){
								foreach($this->default_data['data']['FoJobNotifications'] as $job){?>
                    ...
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                ...
                                <span><?= ucwords($this->session->userdata('rudra_admin_name')) ?></span>
                                <a href="<?= base_url('admin/logout') ?>" class="dud-logout" title="Logout">
                                    <i class="feather icon-log-out"></i>
                                </a>
                            </div>
                            <ul class="pro-body">
								<li><a href="<?= base_url('admin/profile') ?>" class="dropdown-item"><i class="feather icon-settings"></i>Profile Settings</a></li>
